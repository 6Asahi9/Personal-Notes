...
// ! for some reason expressSession is giving error and saying "not defined"

// app.use(
//   session({
//     resave: false, // don't save if the session value is the same already as previous one
//     saveUninitialized: false, // don't save unnamed values or files
//     secret: "your-secret-key", // this should be a secret key for your application. this key will be used to encrypt the data
//   })
// );
